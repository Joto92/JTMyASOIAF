...
## 2.9. Baratheon of King's Landing
...
## 2.12. House Bolton
Our Blades Are Sharp: +5 [ICON_Strength] Combat Strength against damaged units.
### 2.12.1. Leaders
* Roose Bolton | The Leach Lord: Additional Military policy slot.
### 2.12.2 Units
* Dreadfort Pikeman: Bolton unique anti-cavalry unit. +5 [ICON_Strength] Combat Strength if there is at least one Dreadfort Pikeman adjacent.
### 2.12.3 Buildings
* Flayed's Cross: Gives 2 [ICON_Culture] Culture, 1 [ICON_Production] Production and 1 Point for a Great General. Replace the Monument.

## 2.13. House Frey
We Stand Together: +15% [ICON_Production] Production towards districts and wonders if placed next to a River.
### 2.13.1. Leaders
* Walder Frey | Lord of the Crossing: Other civilizations' [ICON_TradeRoute] Trade Routes to the Freys provide +2 [ICON_Gold] Gold for The Freys.
### 2.13.2 Units
* Frey Crossbowman: Frey unique Medieval era ranged unit that replaces Crossbowman. Half of the attack of the Crossbowman, but can attack twice per turn.
### 2.13.3 Buildings
* River Tower: Gives 4 [ICON_Gold] Gold and +10 Defence Hit Points to the City. Must be adjacent to a river. 1 Point for Great Merchants.

## 2.14. Night's Watch
Black Brothers: Extra territory upon founding cities and additional Diplomatic policy slot.
### 2.14.1. Leaders
* Jeor Mormont | The Old Bear: When you capture a Barbarian Outpost, receive a Tribal Village reward in addition to the usual [ICON_Gold] Gold. Pay half the usual cost to levy city-state units.
### 2.14.2 Units
* Ranger Brothers: Night's Watch unique Medieval era meele unit that replaces Swordman. +5 [ICON_Strength] Combat Strength in Forests.
### 2.14.3 Buildings
* Vault: Gives 2 [ICON_Food] Food , 1 [ICON_Culture] Culture and 1 [ICON_Science] Science.

## 2.15. The Freefolk
Wildings: Extra territory upon founding cities and can move through Woods and Rainforest without [ICON_Movement] Movement penalty.
### 2.15.1. Leaders
* Mance Rayder| King-Beyond-the-Wall: Receive a second wilding unit each time you train a wilding unit.
### 2.15.2 Units
* Wilding: Wilding unique meele unit that replaces Swordman. Can see through features.
* Giant: Wilding unique meele unit that replaces Horseman. +5 [ICON_Strength] Combat Strength against melee units.
* Mammoth: Wilding unique meele unit that replaces Heavy Chariot.-5 [ICON_Strength] Combat Strength to adjacent enemy units.
* Spearwives
### 2.15.3 Improvements
* Freefolk Camp: +2 [ICON_Production] Production. Occupying unit receives +4 [ICON_Strength] Defense Strength, and automatically gains 2 turns of fortification.

## 2.16. Baratheon of Storm's End
...
## 2.29. (EXTRA) House Blackfyre
Fire And Blood: +10 [ICON_Strength] Combat Strength when fighting on a continent other that your [ICON_Capital] Capital's. Units receive a +5 [ICON_Strength] Combat Strength on their home continent.
### 2.29.1. Leaders
* Daemon Blackfyre | The Black Dragon: Pay 75% less of the usual cost to levy city-state units. +5% [ICON_Culture] Culture per city-state you are the Suzerain of.
### 2.29.2 Units
* Golden Company
* Essos War Elephant
* Marches Archer
...
# 3. City States
## 3.1. MILITARISTIC: 
* Tyrosh: Receive the [ICON_RESOURCE_DYES] Dyes Luxury resource and naval units receive +4 [ICON_Strength] Combat Strength in shallow water tiles.
* Astapor: Anti-cavalry units receive +4 [ICON_Strength] Combat Strength.
* Elyria: Naval Melee units gain 50% more experience than usual.
* Tolos: Ranged land units receive +4 [ICON_Strength] Combat Strength.
## 3.2. CULTURAL: 
* Lorath: Your districts on or next to Coast tiles provide +1 [ICON_Culture] Culture and +1 Food [ICON_Food].
* New Ghis: +1 [ICON_Culture] Culture for routes between your own cities.
* Summer Islands: +10% faster growth for cities.
* Mantarys: Accumulate 20% less war weariness than usual.
* Lhazosh: All Pastures gain +1 [ICON_Culture] Culture.
## 3.3. TRADE: 
* Braavos: +50% [ICON_GOLD] Gold yield from Commercial Hub buildings and Other civilizations' [ICON_TRADEROUTE] Trade Routes to you provide +1 [ICON_FAITH] for you.
* Pentos: Other civilizations' [ICON_TRADEROUTE] Trade Routes to you provide +1 Gold [ICON_GOLD] and +1 Production [ICON_Production] for you.
* Myr: Receive the [ICON_RESOURCE_WINE] Wine, [ICON_RESOURCE_CITRICS] Citrics and [ICON_RESOURCE_SILK] Silk Luxury resources.
* Meereen: Your [ICON_TradeRoute] Trade Routes to foreign cities earn +1 [ICON_Gold] Gold for each Luxury resource at the destination.
* Ibben: All your districts get +1 [ICON_GOLD] Gold from adjacent Coast tiles.
* Qarth: Your [ICON_TradingPost] Trading Posts in foreign cities provide +1 [ICON_Gold] Gold to your [ICON_TradeRoute] Trade Routes passing through.
## 3.4. SCIENTIFIC: 
* Lys: Receive the [ICON_RESOURCE_WINE] Wine and [ICON_RESOURCE_SILK] Silk Luxury resources.
## 3.5. INDUSTRIAL: 
* Qohor: Other civilizations' [ICON_TRADEROUTE] Trade Routes to you provide +1 Science [ICON_SCIENCE] for you.
* Yunkai: Your Bonus resources behave like Luxury resources, providing 1 [ICON_Amenities] Amenity per type.
* Saath: Industrial Zones gain +1 [ICON_Production] if next to a river.
## 3.6. RELIGIOUS: 
