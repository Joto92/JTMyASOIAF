...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Jordi\Escritorio\ModdingIcons\SOIAF\V3\Governors\GovernorSelected\GovernorSelected_Melissandre.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3974541132</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="GovernorSelected_Melissandre.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="GovernorSelected_Melissandre"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
