...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Jordi\Escritorio\ModdingIcons\SOIAF\V3\Governors\GovernorSelected\GovernorSelected_Hound.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2556427246</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="GovernorSelected_Hound.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="GovernorSelected_Hound"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
