...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Jordi\Escritorio\ModdingIcons\SOIAF\V3\Governors\GovernorSelected\GovernorSelected_Craster.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3184457012</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="GovernorSelected_Craster.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="GovernorSelected_Craster"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
