...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Jordi\Escritorio\ModdingIcons\SOIAF\V3\Governors\GovernorNormal\GovernorNormal_HighSparrow.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4091593907</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="GovernorNormal_HighSparrow.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="GovernorNormal_HighSparrow"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
