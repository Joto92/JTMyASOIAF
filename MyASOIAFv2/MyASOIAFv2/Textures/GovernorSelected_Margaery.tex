...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Jordi\Escritorio\ModdingIcons\SOIAF\V3\Governors\GovernorSelected\GovernorSelected_Margaery.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4189745034</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="GovernorSelected_Margaery.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="GovernorSelected_Margaery"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
