...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Jordi\Escritorio\ModdingIcons\SOIAF\V3\Governors\set\art\MyASOIAF_Governors32.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4082432225</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="MyASOIAF_Governors32.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="MyASOIAF_Governors32"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
