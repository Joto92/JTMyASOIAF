...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Jordi\Escritorio\ModdingIcons\SOIAF\V3\Governors\GovernorSelected\GovernorSelected_JonConnington.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>807083162</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="GovernorSelected_JonConnington.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="GovernorSelected_JonConnington"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
