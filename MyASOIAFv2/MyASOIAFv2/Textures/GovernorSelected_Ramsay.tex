...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Jordi\Escritorio\ModdingIcons\SOIAF\V3\Governors\GovernorSelected\GovernorSelected_Ramsay.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2949713117</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="GovernorSelected_Ramsay.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="GovernorSelected_Ramsay"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
