...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Jordi\Escritorio\ModdingIcons\SOIAF\V3\Governors\GovernorSelected\GovernorSelected_SamwellTarly.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2719383970</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="GovernorSelected_SamwellTarly.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="GovernorSelected_SamwellTarly"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
